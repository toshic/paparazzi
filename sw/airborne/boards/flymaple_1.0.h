#ifndef CONFIG_FLYMAPLE_1_0_H
#define CONFIG_FLYMAPLE_1_0_H

#define BOARD_FLYMAPLE
...
#define BOARD_ADC_CHANNEL_4 ADC_Channel_13
#define BOARD_ADC_CHANNEL_5 ADC_Channel_14
// we can only use ADC1,2,3,4,5; the last channel is for bat monitoring
#define BOARD_ADC_CHANNEL_6 ADC_Channel_15

/* provide defines that can be used to access the ADC_x in the code or airframe file
 * these directly map to the index number of the 6 adc channels defined above
 * 6th (index 5) is used for bat monitoring by default
 */
#define ADC_1 0
#define ADC_2 1
#define ADC_3 2
